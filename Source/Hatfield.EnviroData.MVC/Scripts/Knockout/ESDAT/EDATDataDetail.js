var ESDATDataDetailViewModel = function () {
    var self = this;
    ...
    self.FetchDataWithVersionData = function (versionIndex) {
        ...
        $.ajax({
            url: Hatfield.RootURL + 'api/QueryDataAPI/GetSampleCollectionActionInESDAT/' + self.SelectedActionId + '?version=' + tempVersionIndex,
            type: 'GET',
            dataType: 'json',
            async: false,
            cache: false,
...
};//end of ESDATDataDetailViewModel
